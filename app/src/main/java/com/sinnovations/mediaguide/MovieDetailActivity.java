...
import static com.sinnovations.mediaguide.MovieListActivity.MOVIE_ITEM_LIST;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //Get the reference to the selected movie
                String id = getIntent().getStringExtra(MovieDetailFragment.ARG_ITEM_ID);
                Movie movie = MOVIE_ITEM_LIST.get(Integer.valueOf(id)-1);

                Intent sendIntent = new Intent();
                sendIntent.setAction(Intent.ACTION_SEND);
                sendIntent.putExtra(Intent.EXTRA_TEXT, movie.shareMovie());
                sendIntent.setType("text/plain");
                startActivity(Intent.createChooser(sendIntent, getResources().getText(R.string.text_share)));
            }
        });
